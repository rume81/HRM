...
<div class="container middle_page registration">
        <div class="col-xs-4">
            <img src="images/profile_logo.png" alt="" class="logo" />
        </div>
        <div class="col-xs-4">
        	<input type="file" class="logo form-control" name="profile_img" id="profile_img" />
        ...
        <div class="col-xs-12 emp_profile">
            <form class="form-horizontal" name="register_employee" id="register_employee" action="${rc.contextPath}/register_employee" method="post">
                ...
                <div class="form-group">
                    <label for="designation1" class="col-sm-3 control-label">I am creating profile as</label>
                    <div class="col-sm-3">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="file" class="" name="emp_num" id="emp_num" />
                    </div>
                    <label class="col-sm-2">NDA</label>
                    <div class="col-sm-3">
                        <input type="file" class="" name="branch_name" id="branch_name" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-5 col-sm-2">
                        <button type="button" class="btn btn-primary" onclick="registration('${rc.contextPath}')"><img src="images/submit_for_approval.png" alt="" /> Submit for Approval</button>
                    </div>
                </div>
            </form>
        </div>
